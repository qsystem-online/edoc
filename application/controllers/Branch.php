...
class Branch extends MY_Controller
{
    ...
    public function lizt()
    {
        ...
        $this->list['addnew_ajax_url'] = site_url() . 'branch/add';
        $this->list['pKey'] = "id";
        $this->list['fetch_list_data_ajax_url'] = site_url() . 'branch/fetch_list_data';
        $this->list['delete_ajax_url'] = site_url() . 'branch/delete/';
        $this->list['edit_ajax_url'] = site_url() . 'branch/edit/';
        $this->list['arrSearch'] = [
    ...
    private function openForm($mode = "ADD", $fin_branch_id = 0)
    {
        ...
        $page_content = $this->parser->parse('pages/branch/form', $data, true);
        $main_footer = $this->parser->parse('inc/main_footer', [], true);
    ...
    public function fetch_list_data()
    {
        ...
        $this->datatables->setTableName("branch");
    ...
    {
        $result = $this->branch_model->getAllList();
	...
	public function report_branch(){
		...
		$this->load->model("branch_model");
		$listBranch = $this->branch_model->get_Branch();
        $data = [
			"datas" => $listBranch
		];
