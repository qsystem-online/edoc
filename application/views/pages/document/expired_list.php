	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-info">
				...
				<div class="box-tools">
					<a id="btnNew" data-toggle="confirmation" href="<?=$addnew_ajax_url?>" class="hide btn btn-primary btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> New Record</a>
				</div>
			...
			<div class="box-body">
                <div style="float:left">
					...
					<span>
                        <input type="text" class="datepicker" id="fdt_expired_date" value=""/>
					</span>
				</div>
...
<script type="text/javascript">
	$(function(){	
        $("#fdt_expired_date").change(function(e){
            $('#tblList').DataTable().draw(false);
        });
		...
		$('#tblList').on('preXhr.dt', function ( e, settings, data ) {
             ...
             data.expiredDate = $("#fdt_expired_date").val();
		}).DataTable({
			columns:[
                <?php
