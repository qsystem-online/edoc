...
| security, but you may wish (or even need) to change XX the values in
...
//defined('BASE_URL') OR define ('BASE_URL','http://edoc.qsystem-online.com');
defined('BASE_URL') OR define ('BASE_URL', 'http://localhost/edoc'); // 18/03/2020 enny -> localhost/edoc
