...
/*Data for the table `flow_control_schema_list` */

insert  into `flow_control_schema_list`(`fin_id`,`fin_flow_control_schema_id`,`fin_user_id`,`fin_seq_no`,`fst_active`,`fdt_insert_datetime`,`fin_insert_id`,`fdt_update_datetime`,`fin_update_id`) values (1,1,1,1,'A','2019-04-13 18:28:59',1,'0000-00-00 00:00:00',0);
